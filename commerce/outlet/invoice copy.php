...
<head>
  ...
  <link rel="shortcut icon" href="includes/logos/<?php echo htmlspecialchars($outlet_name, ENT_QUOTES, 'UTF-8'); ?>.png" type="image/x-icon">k
</head>
<style>
  .logo-circle {
    border-radius: 50%;
...
<body class="w3-light-grey">
  ...
  <div id="app">
        ...
        <div class="w3-bar-item w3-right w3-hide-small">
          <div class="w3-dropdown-hover">
            ...
            <div class="w3-dropdown-content w3-bar-block w3-border w3-white w3-card-4">
              <a href="./profile.html" class="w3-bar-item w3-button w3-small w3-hover-theme">Profile</a>
              <a href="./login.html" class="w3-bar-item w3-button w3-small w3-hover-theme">Logout</a>
            </div>
          </div>
        </div>
    ...
    <a href="#refer" class="w3-bar-item w3-button w3-padding-large w3-hover-text-primary">
        <i class="fa fa-fw fa-users w3-text-danger"></i>&nbsp; Refer a Friend 
    </a>
    ...
    <div class="w3-main" style="margin-top:54px">
      ...
      <footer class="w3-padding w3-border-top w3-center w3-white w3-margin-top">
        <span class="w3-opacity">Powered with <span class="w3-text-red">♥</span> by <a href="https://Spurz.com" target="_blank"><strong>Spurz.com</strong></a>.</span>
      </footer>
    </div>
  </div>
</body>
