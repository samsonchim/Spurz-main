                            ...
                            <div class="row row-cards">
                              <div class="col-md-5">
                                ...
                                <input type="hidden" id="idInput" name="product_id">
                                  ...
                                  <input type="text" name="customer_name" class="form-control" placeholder="Customer's Name" value="<?php echo $customerName; ?>">
                                </div>
                              </div>
                              <div class="col-sm-6 col-md-3">
                                <div class="mb-3">
                                  <label class="form-label">Product name</label>
                                  <input type="text" name="product_name" class="form-control" placeholder="Product Name" value="<?php echo $productName; ?>">
                                </div>
                              </div>
                              ...
                              <div class="col-md-12">
                                <div class="mb-3">
                                  ...
                                  <input type="text" name="expected_delivery_date" class="form-control" placeholder="12/04/2026" value="<?php echo $expectedDeliveryDate; ?>">
                                </div>
                              </div>
