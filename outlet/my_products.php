...
<html lang="en">
  ...
  .card {
    width: 70% !important; /* Adjust the width of the card as needed */
    height: 100% !important; /* Adjust the height of the card as needed */
    display: flex;
...
// Fetch products related to the user ID
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
           ...
           // Fetch images for the current product
            ...
            // Output HTML for the carousel
            echo '<div class="col-md-6">';
            echo '<a href="php/uploads/' . $product_id . '_(' . $i . ').png">Link to Image</a>';
            ...
            echo '<div id="carousel-' . $product_id . '" class="carousel slide" data-bs-ride="carousel">';
            echo '<div class="carousel-inner">';

            // Output carousel items
            foreach ($images as $index => $image) {
                echo '<div class="carousel-item' . ($index === 0 ? ' active' : '') . '">';
                echo '<img id="carouselImages"class="d-block w-100" alt="" src="' . $image . '">';
                echo '</div>';
            }

            echo '</div>';
            echo '<a class="carousel-control-prev" href="#carousel-' . $product_id . '" role="button" data-bs-slide="prev">';
            echo '<span class="carousel-control-prev-icon" aria-hidden="true"></span>';
            echo '<span class="visually-hidden">Previous</span>';
            echo '</a>';
            echo '<a class="carousel-control-next" href="#carousel-' . $product_id . '" role="button" data-bs-slide="next">';
