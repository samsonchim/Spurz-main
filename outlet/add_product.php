...
$sql = "INSERT INTO products (product_name, product_category, items_in_stock, price, product_type)
        VALUES (?, ?, ?, ?, ?)";
...
$stmt->bind_param("ssdis", $product_name, $product_category, $items_in_stock, $price, $product_type);
$stmt->execute();
