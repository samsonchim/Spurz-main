          ...
          <View style={styles.container}>
            ...
            <Pressable
              ...
              onPress={async () => {
                ...
                setSubmitting(true);
                try {
                  // Call API login; requires the API server to be configured with Supabase
                  ...
                  setErrMsg(resp.error || 'Invalid credentials');
                  setErrVisible(true);
                } catch (e) {
            ...
            >
              <Text style={styles.loginText}>{submitting ? 'Signing in…' : 'Login'}</Text>
            </Pressable>
