  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Pressable style={[styles.saveBtn, !canSave && { opacity: 0.5 }]} disabled={!canSave || saving} onPress={handleCreate}>
          <Text style={styles.saveTxt}>{saving ? 'Creating...' : 'Create Product'}</Text>
        </Pressable>
